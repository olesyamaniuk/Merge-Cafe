document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".e-navigation-list");
  const headerRef = document.querySelector(".e-header");
  const navigationRef = document.querySelector(".e-navigation");
